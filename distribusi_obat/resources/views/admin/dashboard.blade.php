...
<script>
    ...
    function handleComplexExport(format) {
        ...
        if (!startDate || !endDate) {
            Swal.fire({ icon: 'warning', title: 'Rentang Tanggal Kosong', text: 'Silakan pilih rentang tanggal ekspor.', confirmButtonColor: '#5c6bc0' });
            return;
        }
        ...
        const baseUrl = format === 'excel' ? '/admin/export/excel' : '/admin/export/pdf';
