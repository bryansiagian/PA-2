...
<head>
  ...
  <style>
    :root { --primary: #3fbbc0; --secondary: #2c4964; --light-bg: #f4f9f9; }
    ...
    @media (max-width: 576px) {
        ...
        .card-catalog-stock { font-size: 10px !important; }
    }
  </style>
</head>
...
<body class="index-page">
  ...
  <footer>
    <div class="container text-center text-md-start">
      ...
      <div class="text-center mt-5 pt-4 border-top border-secondary opacity-50 small">© 2024 Yayasan E-Pharma. All Rights Reserved.</div>
    </div>
  </footer>
