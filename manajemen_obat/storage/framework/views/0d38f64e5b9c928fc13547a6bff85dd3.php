            ...
            <div class="card border-0 shadow-sm rounded-4 h-100">
                ...
                <div class="card-body">
                    <div class="p-3 mb-2 bg-light rounded-3 d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-white text-dark shadow-sm"><?php echo e(app()->version()); ?></span>
                    </div>
                    <div class="p-3 mb-2 bg-light rounded-3 d-flex justify-content-between align-items-center">
                        <span class="small fw-bold text-muted">Versi PHP</span>
                        <span class="badge bg-white text-dark shadow-sm"><?php echo e(PHP_VERSION); ?></span>
                    </div>
...
<?php echo $__env->make('layouts.backoffice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PA-2\manajemen_obat\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>